...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://movieloverzz:I1W6lDCnX2S1S0wQ@cluster0.14xng.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "movieloverzz")
...
URL = "https://loki-8-nov-2024-bot-v2-7f49cf08705b.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://loki-8-nov-2024-bot-v2-7f49cf08705b.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://loki-8-nov-2024-bot-v2-7f49cf08705b.herokuapp.com/".format(FQDN)
else:
    URL = "https://loki-8-nov-2024-bot-v2-7f49cf08705b.herokuapp.com/".format(FQDN)
