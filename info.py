...
URL = "https://www.movieloverzz.my.id/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://www.movieloverzz.my.id/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://www.movieloverzz.my.id/".format(FQDN)
else:
    URL = "https://www.movieloverzz.my.id/".format(FQDN)
